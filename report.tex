...
\section{CONCLUSION}
\paragraph{}
Seeing where people look while using your Web site, Web application, or software product sounds like an opportunity to get amazing insights into their user experience. But current eyetracking based UX studies are expensive and requires extra effort and specialized knowledge. This prevents startups and small companies to gather hidden UX insights of their product. Our webcam based eye tracking combined with other user inputs will generate UX reports that can be understood by every UX researcher.
